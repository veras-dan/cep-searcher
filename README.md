...
API que busca o cep e retorna as informações ao usuário.

## Funcionalidades

- Localiza logradouro e algumas informações básicas.
...
```bash
  git clone https://github.com/veras-dan/cep-searcher
```
